...
# note: the below is the original script from https://opencode.ai/install
# because the 'INSTALL_DIR' is hardcoded to $HOME/.opencode/bin, 
# we need to do some nonsense to curl the script and modify it on-the-fly
# to install to $XDG_BIN_HOME instead.
XDG_BIN_HOME=${XDG_BIN_HOME:-$HOME/.local/bin}
curl -fsSL https://opencode.ai/install | sed "s|INSTALL_DIR=\$HOME/.opencode/bin|INSTALL_DIR=$XDG_BIN_HOME|g" | bash
